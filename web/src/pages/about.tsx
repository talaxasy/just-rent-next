...
const About: React.FC<registerProps> = ({ }) => {
            ...
            <Layout>
                <Wrapper>
                    <Box w='100%' px={4} display='flex' flexDirection='column' my={10}>
                        <Box mx='auto' w='fit-content' fontSize='26px' fontWeight='bold' my={2}><Heading>О нас</Heading></Box>
                        <Flex>
                            <Flex w='50%'>
                                <Image src='/system/home_3.jpg' w={600} borderRadius='20px' my={7} />
                            </Flex>
                            <Flex flexDirection='column' w='50%' justifyContent='center' alignItems='center'>
                                <Heading fontSize='24px'>История создания</Heading>
                                <Text>
                        ...
                        <Flex mt={5} flexDirection='row-reverse'>
                            <Flex w='50%' justifyContent='flex-end'>
                                <Image src='/system/home_6.jpg' w={600} borderRadius='20px' my={7} />
                            </Flex>
                            <Flex flexDirection='column' w='50%' justifyContent='center' alignItems='center'>
                                <Heading fontSize='24px'>Направление</Heading>
                                <Text>
