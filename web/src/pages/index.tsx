          ...
          <ModalContent paddingBottom="20px">
            ...
            <ModalBody display="flex" flexDir="column" alignItems="center">
              <Flex flexDir="column" justifyContent="center" alignItems="center">
                <Text fontSize="lg">
                  Чтобы разместить жильё, пожалуйста, укажите свой номер телефона в профиле.
                </Text>
                <NextLink href="/profile/settings">
                  <Button colorScheme="airbnb" mt={5} w="100%" maxW="250px" type="submit">
      ...
      <Layout footer>
        <Wrapper variant="infinite">
          <Box
            ...
            boxShadow="lg"
            width="100%"
            bg="url(/system/home_7_croped.jpg) center no-repeat"
