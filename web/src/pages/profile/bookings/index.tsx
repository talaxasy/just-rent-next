...
const Bookings: React.FC<indexProps> = ({}) => {
  ...
  useEffect(() => {
    if (loadingCustomerHistory && !dataCustomerHistory?.getCustomerBookings) {
      ...
      setCustomerListHistory(
        <GetCustomerBookings getCustomerBookings={dataCustomerHistory} finished />,
      );
    }
