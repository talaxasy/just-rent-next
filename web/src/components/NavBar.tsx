      ...
      >
        <Box maxW="1300px" w="100%" px={4} display="flex" className="">
          ...
          >
            <NextLink href="/">
              <Link lineHeight="0">
                <Image src="/system/logo2.svg" alt="logo" width={175} height={43} />
              </Link>
            </NextLink>
              ...
              <MenuList>
                {!data?.me ? (
                  <MenuGroup title="Профиль">
                    <NextLink href="/login">
                      <MenuItem suppressHydrationWarning>Войти</MenuItem>
                    </NextLink>
                    <NextLink href="/register">
                      <MenuItem suppressHydrationWarning>Регистрация</MenuItem>
                    </NextLink>
                  </MenuGroup>
                ) : (
                  <MenuGroup title="Профиль">
                    ...
                    <NextLink href="/profile">
                      <MenuItem suppressHydrationWarning>Аккаунт</MenuItem>
                    </NextLink>
                  </MenuGroup>
                )}
                <MenuDivider />
