...
import { HousesQuery, useDeleteHouseMutation, useMeQuery, useReviewsQuery } from '../generated/graphql';
...
const ListOfHouses: React.FC<ListOfHousesProps> = ({ data }) => {
    ...
    return (
        <SimpleGrid minChildWidth="250px" spacing="40px">
            {data!.houses.houses.map((el) => !el ? null : (
