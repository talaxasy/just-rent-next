...
const ImportantUserFields_1 = require("./types/ImportantUserFields");
...
let UserResolver = class UserResolver {
    ...
    forgotPassword(email, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield redis.set(constants_1.FORGET_PASSWORD_PREFIX + token, user.id, 'ex', 1000 * 60 * 60 * 3);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [ImportantUserFields_1.ImportantUserFields, Object]),
    __metadata("design:returntype", Promise)
