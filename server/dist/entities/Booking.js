...
__decorate([
    ...
    typeorm_1.Column(),
    __metadata("design:type", Number)
], Booking.prototype, "guests_count", void 0);
__decorate([
    type_graphql_1.Field(),
...
__decorate([
    ...
    typeorm_1.ManyToOne(() => User_1.User, user => user.booking),
...
__decorate([
    ...
    typeorm_1.Column(),
    __metadata("design:type", Number)
], Booking.prototype, "houseId", void 0);
__decorate([
    type_graphql_1.Field(() => House_1.House),
    typeorm_1.ManyToOne(() => House_1.House, house => house.booking, {
        onDelete: 'CASCADE'
    }),
    __metadata("design:type", House_1.House)
], Booking.prototype, "house", void 0);
__decorate([
    type_graphql_1.Field(() => String),
